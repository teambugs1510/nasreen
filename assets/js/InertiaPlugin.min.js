...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = t || self).window = t.window || {}) }(this, function(e) {
    ...
    function u(t, e, n, i) { this.t = t, this.p = e, this.g = t._gsap.get, this.rCap = d[n || o(this.g(t, e))], this.v1 = this.v2 = 0, this.t1 = this.t2 = c.time, i && ((this._next = i)._prev = this) }
    var n, l, g, o, a, c, i, s, f = {},
        ...
        h = function() {
            ...
            VelocityTracker.register = function register(e) { n = e, t() };
            ...
            return e.get = function get(t, e) {
                ...
                return n = parseFloat(e ? r.v1 : r.g(r.t, r.p)) - parseFloat(r.v2), (i = r.rCap) && (n %= i) !== n % (i / 2) && (n = n < 0 ? n + i : n - i),
                    function _round(t) { return Math.round(1e4 * t) / 1e4 }(n / ((e ? r.t1 : c.time) - r.t2))
            }, e.getAll = function getAll() {
                var t, e = {},
                    n = this._props;
                for (t in n) e[t] = this.get(t);
                return e
            }, e.isTracking = function isTracking(t) { return t in this._props }, e.add = function add(t, e) { t in this._props || (a || (c.add(r), i = c.time), a = this._props[t] = new u(this.target, t, e, a)) }, e.remove = function remove(t) {
            ...
            }, VelocityTracker.isTracking = function isTracking(t, e) { var n = q(t); return n && n.isTracking(e) }, VelocityTracker.getVelocity = function getVelocity(t, e) { var n = q(t); return n && n.isTracking(e) ? n.get(e) : console.warn("Not tracking velocity of " + e) }, VelocityTracker
        }();
    ...
    function ha() {
        (v = J()) && (y = v.parseEase, x = v.utils.toArray, P = v.utils.getUnit, V = v.core.getCache, O = v.utils.clamp, w = y("power3"), k = w(.05), F = v.core.PropTween, v.config({ resistance: 100, unitFactors: { time: 1e3, totalTime: 1e3, progress: 1e3, totalProgress: 1e3 } }), b = v.config(), v.registerPlugin(h), T = 1)
    }
    var v, T, y, x, w, b, P, F, V, k, O, A, C = h.getByTarget,
        E = "InertiaPlugin",
        j = Q(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        I = function(t) {
            var e = 0 === (window ? window.location.href : "").indexOf(Q(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(Q(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== t.indexOf(Q(49, 50, 55, 46, 48, 32, 48, 46, 49)),
        ...
        S = {
            version: "3.8.0",
            name: "inertia",
            register: function register(t) { v = t, ha() },
            ...
            render: function render(t, e) { var n = e._pt; for (t = w(e.tween._time / e.tween._dur); n;) n.set(n.t, n.p, Y(n.s + n.c1 * t + n.c2 * t * t) + n.u, n.d, t), n = n._next }
        };
    "track,untrack,isTracking,getVelocity,getByTarget".split(",").forEach(function(t) { return S[t] = h[t] }), J() && v.registerPlugin(S), e.InertiaPlugin = S, e.VelocityTracker = h, e.default = S;
